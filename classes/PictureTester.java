...
public class PictureTester
{
    ...
    {
        Picture canvas = new Picture("480x600.jpg");
        canvas.myCollage();
        canvas.explore();
    }
    ...
    public static void testMyEdgeDetection()
    {
        ...
        ZiggyJulie.myEdgeDetection(10);
        ZiggyJulie.explore();
    }

    public static void colorEdge(){
        Picture ZiggyJulie = new Picture("SplitsStreetFair.jpg");
        ZiggyJulie.colorEdge(15);
        ZiggyJulie.explore();
    }
